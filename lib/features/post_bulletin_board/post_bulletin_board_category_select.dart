...
class PostBulletinBoardCategorySelect extends StatefulWidget {
  const PostBulletinBoardCategorySelect({super.key});

  @override
  State<PostBulletinBoardCategorySelect> createState() =>
      _PostBulletinBoardCategorySelect();
}

// ignore: camel_case_types
class _PostBulletinBoardCategorySelect
    extends State<PostBulletinBoardCategorySelect> {
  // 現在選択されているカテゴリ名を保持
