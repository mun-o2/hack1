...
class BulletinBoardWritingSpace extends StatefulWidget {
  const BulletinBoardWritingSpace({super.key});

  @override
  State<BulletinBoardWritingSpace> createState() =>
      _BulletinBoardWritingSpaceState();
}

class _BulletinBoardWritingSpaceState extends State<BulletinBoardWritingSpace> {
  //コントローラー
