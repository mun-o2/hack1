import 'bulletin_board_category_select.dart';
import 'bulletin_board_writing_space.dart';
...
class BulletinBoard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final writingSpace = BulletinBoardWritingSpace();
    final categorySelect = bulletin_board_category_select();
